            ...
            <div class="d-flex justify-content-between">
                ...
                <form action="discount-doUpdate.php" method="POST" class="mb-3">
                    <ul>
                        ...
                        <li>活動簡介</li>
                        <li><textarea type="text" class="form-control my-3 fw-bold" style="width: 1200px; height:420px;" 
                        name="content" readonly><?=$row["content"]?></textarea></li>
                        <li class="mb-3">折扣內容</li>
                        <div class="d-flex">
                            <div class="d-flex">
                                <li class=" fw-bold text-color">
                                    <?php if ($row["discount_type_id"]==1) print("折數 ")?> 
                                    <?php if ($row["discount_type_id"]==1) print($row["product_discount"])?> 
                                    <?php if ($row["discount_type_id"]==2) print("滿 ")?> 
                                    <?php if ($row["discount_type_id"]==2) print($row["pay"])?> 
                                    <?php if ($row["discount_type_id"]==2) print(" 折 ")?> 
                                    <?php if ($row["discount_type_id"]==2) print($row["product_discount"])?> 
                                </li>
                            </div>
                        </div>
                        <li class="pt-4">活動期間</li>
                            <div class="d-flex">
                                ...
                                <li><div class="pt-4 fw-bold text-color px-3">至</div></li>
                    ...
                    <div class="text-end me-5 button">
                        <a href="discount.php" class="btn btn-cancel mx-2">返回列表</a>
                    </div>
            </form>
        </div>
    <?php else: ?>
