      ...
      <div class="mt-3 ms-3 container-fluid d-flex">
        <div class="member-card col-5">
          ...
          <?php if ($row > 0) : $result->rowCount(); ?>
            ...
            <div class="mx-2">
              <a href="brand-list.php" class="return-btn me-2 btn btn-members-list">回到管理分類</a>
              <a href="brand-edit.php?id=<?= $id ?>" class="edit-btn btn btn-main-color me-2 btn-members-list">修改</a>
            </div>
        </div>
