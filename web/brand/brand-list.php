...
<body>
  ...
  <main>
    ...
    <a class="btn btn-main-color" href="store.php">回到品牌管理</a>
        ...
        <table class="table align-items-center">
          ...
          <?php foreach ($categories as $category) : ?>
            <tbody class=text-center>
              ...
              <th class="pt-3"><input value="<?= $category["id"] ?>" name="name" class="me-4" type="checkbox">
                <?= $category["id"] ?></th>
              <th class="pt-3"><?= $category["category_name"] ?></th>
              <th class="pt-3"><?= $category["category_en_name"] ?></th>
              <th><a class="btn btn-bg-color" href="brand-detail.php?id=<?= $category["id"] ?>">查看</a></th>
            </tbody>
          <?php endforeach; ?>
        </table>
      </div>
